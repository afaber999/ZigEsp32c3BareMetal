...
pub fn setCpuIntr1(value: u1) void {
    _regs[CPU_INTR_FROM_CPU_1 / 4] = value;
}

pub fn setCpuIntr2(value: u1) void {
    _regs[CPU_INTR_FROM_CPU_2 / 4] = value;
}

pub fn setCpuIntr3(value: u1) void {
    _regs[CPU_INTR_FROM_CPU_3 / 4] = value;
}
