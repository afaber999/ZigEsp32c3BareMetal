...
pub const devices = struct {
    ...
    pub const @"ESP32-C3" = struct {
        ...
        pub const peripherals = struct {
            ...
            pub const SPI1: *volatile types.peripherals.SPI1 = @ptrFromInt(0x60002000);
            /// SPI (Serial Peripheral Interface) Controller
            pub const SPI0: *volatile types.peripherals.SPI0 = @ptrFromInt(0x60003000);
            /// General Purpose Input/Output
            pub const GPIO: *volatile types.peripherals.GPIO = @ptrFromInt(0x60004000);
            /// Sigma-Delta Modulation
            pub const GPIOSD: *volatile types.peripherals.GPIOSD = @ptrFromInt(0x60004f00);
            /// Real-Time Clock Control
            pub const RTC_CNTL: *volatile types.peripherals.RTC_CNTL = @ptrFromInt(0x60008000);
            /// eFuse Controller
            pub const EFUSE: *volatile types.peripherals.EFUSE = @ptrFromInt(0x60008800);
            /// Input/Output Multiplexer
            pub const IO_MUX: *volatile types.peripherals.IO_MUX = @ptrFromInt(0x60009000);
            /// Universal Host Controller Interface
            pub const UHCI1: *volatile types.peripherals.UHCI0 = @ptrFromInt(0x6000c000);
            /// UART (Universal Asynchronous Receiver-Transmitter) Controller
            pub const UART1: *volatile types.peripherals.UART0 = @ptrFromInt(0x60010000);
            /// I2C (Inter-Integrated Circuit) Controller
            pub const I2C0: *volatile types.peripherals.I2C0 = @ptrFromInt(0x60013000);
            /// Universal Host Controller Interface
            pub const UHCI0: *volatile types.peripherals.UHCI0 = @ptrFromInt(0x60014000);
            /// Remote Control Peripheral
            pub const RMT: *volatile types.peripherals.RMT = @ptrFromInt(0x60016000);
            /// LED Control PWM (Pulse Width Modulation)
            pub const LEDC: *volatile types.peripherals.LEDC = @ptrFromInt(0x60019000);
            /// Timer Group
            pub const TIMG0: *volatile types.peripherals.TIMG0 = @ptrFromInt(0x6001f000);
            /// Timer Group
            pub const TIMG1: *volatile types.peripherals.TIMG0 = @ptrFromInt(0x60020000);
            /// System Timer
            pub const SYSTIMER: *volatile types.peripherals.SYSTIMER = @ptrFromInt(0x60023000);
            /// SPI (Serial Peripheral Interface) Controller
            pub const SPI2: *volatile types.peripherals.SPI2 = @ptrFromInt(0x60024000);
            /// Advanced Peripheral Bus Controller
            pub const APB_CTRL: *volatile types.peripherals.APB_CTRL = @ptrFromInt(0x60026000);
            /// Hardware random number generator
            pub const RNG: *volatile types.peripherals.RNG = @ptrFromInt(0x60026000);
            /// Two-Wire Automotive Interface
            pub const TWAI: *volatile types.peripherals.TWAI = @ptrFromInt(0x6002b000);
            /// I2S (Inter-IC Sound) Controller
            pub const I2S: *volatile types.peripherals.I2S = @ptrFromInt(0x6002d000);
            /// AES (Advanced Encryption Standard) Accelerator
            pub const AES: *volatile types.peripherals.AES = @ptrFromInt(0x6003a000);
            /// SHA (Secure Hash Algorithm) Accelerator
            pub const SHA: *volatile types.peripherals.SHA = @ptrFromInt(0x6003b000);
            /// RSA (Rivest Shamir Adleman) Accelerator
            pub const RSA: *volatile types.peripherals.RSA = @ptrFromInt(0x6003c000);
            /// Digital Signature
            pub const DS: *volatile types.peripherals.DS = @ptrFromInt(0x6003d000);
            /// HMAC (Hash-based Message Authentication Code) Accelerator
            pub const HMAC: *volatile types.peripherals.HMAC = @ptrFromInt(0x6003e000);
            /// DMA (Direct Memory Access) Controller
            pub const DMA: *volatile types.peripherals.DMA = @ptrFromInt(0x6003f000);
            /// Successive Approximation Register Analog to Digital Converter
            pub const APB_SARADC: *volatile types.peripherals.APB_SARADC = @ptrFromInt(0x60040000);
            /// Full-speed USB Serial/JTAG Controller
            pub const USB_DEVICE: *volatile types.peripherals.USB_DEVICE = @ptrFromInt(0x60043000);
            /// System
            pub const SYSTEM: *volatile types.peripherals.SYSTEM = @ptrFromInt(0x600c0000);
            /// Sensitive
            pub const SENSITIVE: *volatile types.peripherals.SENSITIVE = @ptrFromInt(0x600c1000);
            /// Interrupt Core
            pub const INTERRUPT_CORE0: *volatile types.peripherals.INTERRUPT_CORE0 = @ptrFromInt(0x600c2000);
            /// External Memory
            pub const EXTMEM: *volatile types.peripherals.EXTMEM = @ptrFromInt(0x600c4000);
            /// XTS-AES-128 Flash Encryption
            pub const XTS_AES: *volatile types.peripherals.XTS_AES = @ptrFromInt(0x600cc000);
            /// Debug Assist
            pub const ASSIST_DEBUG: *volatile types.peripherals.ASSIST_DEBUG = @ptrFromInt(0x600ce000);
        };
    };
};
    ...
    pub const peripherals = struct {
        ...
        pub const SPI1 = extern struct {
            ...
            CTRL: mmio.Mmio(packed struct(u32) {
                ...
                FCMD_QUAD: u1,
                reserved10: u1,
                /// For SPI1, initialize crrv322 module before writing encrypted data to flash. Active low.
                FCS_CRC_EN: u1,
                /// For SPI1, enable crrv322 when writing encrypted data to flash. 1: enable 0:disable
                TX_CRC_EN: u1,
                reserved13: u1,
                /// This bit enable the bits: spi_mem_fread_qio, spi_mem_fread_dio, spi_mem_fread_qout and spi_mem_fread_dout. 1: enable 0: disable.
                FASTRD_MODE: u1,
